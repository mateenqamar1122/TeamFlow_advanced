...
const AIInsightsSimple: React.FC = () => {
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8">
                ...
                <p className="text-gray-500">Detailed performance metrics and charts.</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8">
                ...
                <p className="text-gray-500">Interactive AI assistant for management insights.</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8">
                ...
                <p className="text-gray-500">AI-powered custom analysis and report generation.</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
...
export default AIInsightsSimple;
