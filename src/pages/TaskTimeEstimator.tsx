...
const TaskTimeEstimatorPage: React.FC = () => {
  const { user } = useAuth();
          ...
          <CardContent className="flex items-center justify-center py-12">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Please select a workspace to access task time estimation
              </p>
            </div>
          </CardContent>
        </Card>
    ...
    <div className="container mx-auto p-6">
      <div className="mb-6">
        <nav className="text-sm text-muted-foreground mb-2">
          ...
          <span className="mx-2">→</span>
          <span className="text-foreground font-medium">Task Time Estimator</span>
        </nav>
      </div>
...
export default TaskTimeEstimatorPage;
